 ...
 */
public class MsgService extends HostApduService {
    ...
    private static final byte[] SELECT_APDU = BuildSelectApdu(MSG_AID);
    ...
    public byte[] processCommandApdu(byte[] commandApdu, Bundle extras) {
        if (Arrays.equals(SELECT_APDU, commandApdu)) {
            SharedPreferences pref = getSharedPreferences("PREF_NFC",
                    Context.MODE_PRIVATE);
            String msg = pref.getString("PREF_MSG", "DEFAULT");
            byte[] msgBytes = msg.getBytes();
            return ConcatArrays(msgBytes, SELECT_OK_SW);
        } else {
